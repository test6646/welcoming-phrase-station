    ...
    <section id="about" className="py-12 lg:py-20 bg-primary">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        <div className="text-center mb-10 sm:mb-12">
          ...
          <h2 className="text-3xl sm:text-4xl font-serif font-bold text-main mb-4 sm:mb-6 text-center">
            Our Studio Story
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
          <div className="lg:col-span-3">
            <div className="bg-card p-8 shadow-xl h-full flex flex-col border border-primary/10" style={{ borderRadius: 0 }}>
              ...
              <div className="flex-1">
                <h3 className="text-xl font-serif font-bold text-main mb-3">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="bg-card p-8 shadow-xl hover:shadow-2xl transition-all duration-300 group border border-primary/10" style={{ borderRadius: 0 }}>
              <h3 className="text-xl font-serif font-bold text-main mb-6 text-center">
                Founders
              </h3>
              <div className="flex flex-row gap-6 justify-between">
                {owners.map((owner, index) => (
                  <div key={index} className="flex flex-col items-center text-center flex-1">
                    ...
                    <h3 className="text-lg font-serif font-bold text-main">
                      {owner.name}
                    </h3>
                  </div>
                ))}
